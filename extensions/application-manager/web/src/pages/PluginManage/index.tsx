...
const fetchRequestType = new RequestType('remote://plugin/fetch');
const openRequestType = new RequestType('vsc://plugin/open');
const installRequestType = new RequestType('vsc://plugin/install');
const uninstallRequestType = new RequestType('vsc://plugin/uninstall');
const openConfigRequestType = new RequestType('vsc://plugin/open/config');
const reloadRequestType = new RequestType('vsc://plugin/reload');
